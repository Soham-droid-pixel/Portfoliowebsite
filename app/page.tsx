      ...
      <section className="relative pt-32 md:pt-40 pb-16 md:pb-24 z-10">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <p className="text-xl md:text-2xl text-white/80">Full Stack Web Developer || AI ML Data Science Enthusiast</p>
            <p className="max-w-[600px] text-white/70">
              I build exceptional and accessible digital experiences for the web and have made several projects in AI/ML and Data Science.
              <br />
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-white/70">
                I'm a curious and passionate full stack developer with hands-on experience in building modern web applications using React, Node.js, Express.js, and PostgreSQL. I enjoy crafting clean, efficient, and user-focused solutions.
              </p>
              <p className="text-white/70">
                My core strength lies in AI/ML and data science, where I've developed several projects like recommendation systems, stock price prediction models, and demand forecasting tools. I'm also diving into mobile development with React Native and Kotlin.
              </p>
              <p className="text-white/70">
                I love solving real-world problems with data-driven approaches, and I'm always eager to learn new technologies and build meaningful projects that make an impact.
              </p>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              {
                title: "Recipe Finder",
                description: "Personalized recipe recommendation engine based on available ingredients.",
